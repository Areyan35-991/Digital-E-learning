...
<?php $__env->startSection('title', 'Teacher Dashboard - Digital E-Learning'); ?>
            ...
            <div class="p-6 bg-white">
                ...
                <div class="flex justify-between items-center mb-8 pb-6 border-b border-gray-200">
                    <div>
                        ...
                        <p class="text-gray-600">Welcome back, <span class="font-semibold text-gray-800"><?php echo e(Auth::user()->name); ?></span>!</p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div class="bg-blue-50 rounded-lg p-6 border border-blue-200 hover:shadow-md transition">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-2xl font-bold text-gray-800"><?php echo e($assignedCourses->count()); ?></h3>
                    ...
                    <div class="bg-green-50 rounded-lg p-6 border border-green-200 hover:shadow-md transition">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-2xl font-bold text-gray-800"><?php echo e($totalStudents ?? 0); ?></h3>
                    ...
                    <div class="bg-purple-50 rounded-lg p-6 border border-purple-200 hover:shadow-md transition">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-2xl font-bold text-gray-800"><?php echo e($totalLessons ?? 0); ?></h3>
                    ...
                    <div class="bg-red-50 rounded-lg p-6 border border-red-200 hover:shadow-md transition">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-2xl font-bold text-gray-800" id="upcoming-events-count"><?php echo e(count($events ?? [])); ?></h3>
                ...
                <div class="mb-8">
                    ...
                    <?php if($assignedCourses->count() > 0): ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <?php $__currentLoopData = $assignedCourses->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="p-6">
                                    <div class="flex justify-between items-start mb-3">
                                        ...
                                        <span class="px-2 py-1 text-xs font-semibold rounded-full 
                                            <?php echo e($course->skill_level == 'Beginner' ? 'bg-green-100 text-green-800' : 
                                               ($course->skill_level == 'Intermediate' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800')); ?>">
                                            <?php echo e($course->skill_level); ?>
                                    ...
                                    <div class="flex justify-between items-center text-sm text-gray-500 mb-3">
                                        <span>
                                            ...
                                            <?php echo e($course->lessons ?? 0); ?> lessons
                                        </span>
                                        <span>
                                            <i class="fas fa-clock mr-1"></i>
                                            <?php echo e($course->duration_weeks ?? 0); ?> weeks
                                        </span>
                                    </div>
                                    ...
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm text-gray-500">
                                            ...
                                            <?php echo e($course->enrolled_count ?? 0); ?> students
                                        </span>
                                        <span class="text-sm font-semibold text-blue-600">
                                            <?php echo e($course->semester ?? 'N/A'); ?>
                        ...
                        <?php if($assignedCourses->count() > 6): ?>
                            <div class="mt-6 text-center">
                                <a href="<?php echo e(route('teacher.courses.index')); ?>" 
                ...
                <?php if(isset($recentContents) && $recentContents->count() > 0): ?>
                <div class="mt-8">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $recentContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($content->title); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900"><?php echo e($content->course->title ?? 'N/A'); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                <?php echo e($content->content_type == 'video' ? 'bg-red-100 text-red-800' : 
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                <?php echo e($content->is_published ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                                <?php echo e($content->is_published ? 'Published' : 'Draft'); ?>
...
<script>
    ...
    const API_ENDPOINTS = {
        EVENTS: {
            STORE: '<?php echo e(url("/teacher/events")); ?>',
            LIST: '<?php echo e(url("/teacher/events")); ?>',
        }
    };

    // Events data from backend - pass from controller
    const eventsData = <?php echo json_encode($events ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\blc-elearning\resources\views/teacher/dashboard.blade.php ENDPATH**/ ?>