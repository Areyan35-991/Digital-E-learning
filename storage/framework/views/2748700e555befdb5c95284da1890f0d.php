...
<body>
    ...
    <header class="header">
        <div class="header-top">
            <div class="user-info justify-end flex">
                <span><i class="fas fa-user-circle mr-1"></i> <?php echo e(Auth::user()->name ?? 'Student'); ?></span>
                <span><i class="fas fa-envelope mr-1"></i> <?php echo e(Auth::user()->email ?? 'student@example.com'); ?></span>
    ...
    <div class="main-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-links">
                <a href="<?php echo e(route('student.courses')); ?>"><i class="fas fa-book"></i><span>All My Course</span></a>
                <a href="<?php echo e(route('student.events')); ?>"><i class="fas fa-calendar-alt"></i> <span>Upcoming events</span></a>
                <a href="<?php echo e(route('student.leaderboard')); ?>"><i class="fas fa-award"></i> <span>Leaderboard</span></a>
            </div>
        </div>
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="statistics-section" id="statistics-section">
                <div class="statistics-cards">
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <div class="stat-number"><?php echo e($statistics['enrolled_courses']); ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <div class="stat-number"><?php echo e($statistics['completed_courses']); ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <div class="stat-number"><?php echo e($statistics['completed_activities']); ?></div>
            ...
            <div class="courses-section">
                ...
                <div class="courses-carousel" id="courses-container">
                    ...
                    <div class="course-card" data-title="<?php echo e($enrollment->course->title); ?>">
                        <div class="thumbnail" style="background-color: #<?php echo e(substr(md5($enrollment->course->title), 0, 6)); ?>20; color: #<?php echo e(substr(md5($enrollment->course->title), 0, 6)); ?>;">
                            <div class="thumbnail-placeholder"><?php echo e(substr($enrollment->course->title, 0, 15)); ?>...</div>
                        </div>
                        <div class="course-title"><?php echo e($enrollment->course->title); ?></div>
                        <div class="course-progress">
                            <div class="progress-bar">
                                <div class="progress-fill" style="width: <?php echo e($enrollment->progress); ?>%"></div>
                            </div>
                            <span><?php echo e(number_format($enrollment->progress, 0)); ?>% Complete</span>
                        </div>
                        <button class="view-course-btn" onclick="viewCourse(<?php echo e($enrollment->course->id); ?>)">View Course</button>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    
                    <?php if($recentCourses->isEmpty()): ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // API endpoints
            const API_ENDPOINTS = {
                UPDATE_ACCESS: '<?php echo e(route("student.course.update-access", ":courseId")); ?>',
                CALENDAR_EVENTS: '<?php echo e(route("student.calendar-events")); ?>'
            };
            ...
            const eventsData = <?php echo json_encode($upcomingEvents->map(function($event) {
                return [
                    'date' => $event->event_date->format('Y-m-d'), 'title' => $event->title, 'type' => $event->event_type
                ];
            })) ?>;
...
</html><?php /**PATH C:\Users\User\blc-elearning\resources\views/student/dashboard.blade.php ENDPATH**/ ?>