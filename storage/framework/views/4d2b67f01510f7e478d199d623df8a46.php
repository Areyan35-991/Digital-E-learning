            ...
            <div class="nav-container">
                <nav>
                    ...
                    <ul class="nav-links" id="nav-links">
                        ...
                        <li><a href="<?php echo e(route('student.events')); ?>" class="active">Upcoming Events</a></li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="main-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-links">
                ...
                <a href="<?php echo e(route('student.courses')); ?>"><i class="fas fa-book"></i> <span>My Courses</span></a>
                <a href="<?php echo e(route('student.leaderboard')); ?>"><i class="fas fa-trophy"></i> <span>Leaderboard</span></a>
                <a href="<?php echo e(route('student.events')); ?>" class="active"><i class="fas fa-calendar-alt"></i> <span>Upcoming Events</span></a>
...
</html><?php /**PATH C:\Users\User\blc-elearning\resources\views/student/events.blade.php ENDPATH**/ ?>