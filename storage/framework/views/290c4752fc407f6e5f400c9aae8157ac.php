...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Teacher Portal - Digital E-Learning'); ?></title>
        ...
        <header class="header">
            <div class="header-top">
                <div class="user-info justify-end flex">
                    <span><i class="fas fa-user-circle mr-1"></i> <?php echo e(Auth::user()->name); ?></span>
                    <span><i class="fas fa-envelope mr-1"></i> <?php echo e(Auth::user()->email); ?></span>
                ...
                <div class="nav-container">
                    <nav>
                        ...
                        <ul class="nav-links" id="nav-links">
                            ...
                            <li><a href="<?php echo e(route('teacher.dashboard')); ?>" class="<?php echo e(request()->routeIs('teacher.dashboard') ? 'active' : ''); ?>">Dashboard</a></li>
                            <li><a href="#" class="<?php echo e(request()->routeIs('teacher.courses.*') ? 'active' : ''); ?>">My Courses</a></li>
                            <li><a href="#calendar-section">Calendar</a></li>
                            <li><a href="<?php echo e(route('teacher.results.search')); ?>">Student Progress</a></li>
...
</html><?php /**PATH C:\Users\User\blc-elearning\resources\views/layouts/teacher.blade.php ENDPATH**/ ?>