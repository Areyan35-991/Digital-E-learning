      ...
      <div class="auth-card">
        ...
        <form action="{{ route('register') }}" method="POST" id="registrationForm">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter your full name" required value="{{ old('name') }}">
            @error('name')
          ...
          <div class="form-group">
            ...
            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter your educational email" required value="{{ old('email') }}">
            @error('email')
              <div class="error-message">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="tel" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Enter your phone number" value="{{ old('phone') }}">
            @error('phone')
              <div class="error-message">{{ $message }}</div>
            @enderror
          </div>
          ...
          <input type="hidden" name="role" id="selectedRole" value="{{ old('role', 'student') }}" required>
          @error('role')
            <div class="error-message">{{ $message }}</div>
          @enderror
