    ...
    <header class="header">
        <div class="header-top">
            <div class="user-info justify-end flex">
                <span><i class="fas fa-user-circle mr-1"></i> {{ Auth::user()->name ?? 'John Doe' }}</span>
                <span><i class="fas fa-envelope mr-1"></i> {{ Auth::user()->email ?? 'john.doe@example.com' }}</span>
            ...
            <div class="nav-container">
                <nav>
                    ...
                    <ul class="nav-links" id="nav-links">
                        ...
                        <li><a href="{{ route('student.my-courses') }}" class="active">My Courses</a></li>
                        <li><a href="{{ route('student.leaderboard') }}">Leaderboard</a></li>
                        <li><a href="{{ route('student.events') }}">Upcoming Events</a></li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="main-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-links">
                ...
                <a href="{{ route('student.my-courses') }}" class="active"><i class="fas fa-book"></i> <span>All My Courses</span></a>
                <a href="#"><i class="fas fa-folder"></i> <span>Course Materials</span></a>
                ...
                <a href="#"><i class="fas fa-award"></i> <span>Certificates</span></a>
                <a href="#"><i class="fas fa-chart-line"></i> <span>Progress Reports</span></a>
            </div>
        </div>
            ...
            <div class="courses-container">
                ...
                <div class="semester-section" id="past-semesters">
                    ...
                    <div class="courses-grid">
                        ...
                        <!-- Course Card 6 - Upcoming (Next Semester) -->
                        <div class="course-card-full" data-status="upcoming" data-semester="future">
                            <div class="course-card-header">
                                <div>
                                    <div class="course-code">CS-301</div>
                                    <h3 class="course-title-full">Database Systems</h3>
                                    <div class="course-instructor">
                                        <i class="fas fa-user-tie"></i>
                                        <span>Prof. Lisa Thompson</span>
                                    </div>
                                </div>
                            </div>
                            <span class="course-status status-upcoming">Upcoming</span>
                            
                            <div class="course-card-content">
                                <p class="course-description">
                                    Introduction to database design and implementation. SQL, normalization, transactions, and database management systems.
                                </p>
                                ...
                                <div class="progress-section">
                                    ...
                                    <div class="progress-bar-full">
                                        <div class="progress-fill-full" style="width: 0%"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="course-card-footer">
                                <div class="last-accessed">
                                    <i class="fas fa-info-circle"></i> Enrollment confirmed
                                </div>
                                <div class="course-actions">
                                    <button class="course-btn outline" onclick="viewSyllabus(6)">
                                        <i class="fas fa-file-alt"></i> Syllabus
                                    </button>
                                    <button class="course-btn secondary" disabled>
