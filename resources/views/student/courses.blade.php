            ...
            <div class="nav-container">
                <nav>
                    ...
                    <ul class="nav-links" id="nav-links">
                        ...
                        <li><a href="{{ route('student.courses') }}" class="active">All My Courses</a></li>
    ...
    <div class="main-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-links">
                ...
                <a href="{{ route('student.courses') }}" class="active"><i class="fas fa-book"></i> <span>All My Courses</span></a>
