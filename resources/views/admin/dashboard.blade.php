...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h3 class="text-2xl font-bold text-gray-800">{{ $stats['total_teachers'] }}</h3>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-6">
            <div class="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                <div>
                    <h3 class="text-lg font-semibold text-blue-800">{{ $stats['active_semester'] }}</h3>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 gap-4">
                <a href="{{ route('admin.teachers') }}" class="p-4 bg-blue-100 rounded-lg text-center hover:bg-blue-200 transition">
                    <i class="fas fa-chalkboard-teacher text-blue-600 text-xl mb-2"></i>
                    <p class="text-sm font-medium text-blue-800">Manage Faculty</p>
                </a>
                <a href="{{ route('admin.courses') }}" class="p-4 bg-green-100 rounded-lg text-center hover:bg-green-200 transition">
                    <i class="fas fa-book text-green-600 text-xl mb-2"></i>
                    <p class="text-sm font-medium text-green-800">Manage Courses</p>
                </a>
                <a href="{{ route('admin.users') }}" class="p-4 bg-purple-100 rounded-lg text-center hover:bg-purple-200 transition">
                    <i class="fas fa-users text-purple-600 text-xl mb-2"></i>
                    <p class="text-sm font-medium text-purple-800">View Users</p>
                </a>
                <a href="{{ route('admin.teachers.create') }}" class="p-4 bg-orange-100 rounded-lg text-center hover:bg-orange-200 transition">
